...
#import "Util.h"
@interface CoreAnimationController ()<MAMapViewDelegate>
...
- (MAMapView *)map
{
    if (!_map)
    {
        [MAMapServices sharedServices].apiKey= @"0fc1e33778b76046270ffd6b3b7d2718";
...
-(void)addSwitchBtn{
    ...
    [switchBtn setImage:[UIImage imageNamed:@"SwitchOff"] forState:UIControlStateNormal];
    switchBtn.frame = CGRectMake(KScreenWidth-70,KScreenHeight-70, 40, 40);
